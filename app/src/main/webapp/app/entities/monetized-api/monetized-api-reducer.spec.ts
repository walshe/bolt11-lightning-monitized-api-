...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_MONETIZEDAPI_LIST actions', async () => {
    ...
    it('dispatches FETCH_MONETIZEDAPI actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_MONETIZEDAPI actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_MONETIZEDAPI actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_MONETIZEDAPI actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_MONETIZEDAPI actions', async () => {
      const expectedActions = [
        {
