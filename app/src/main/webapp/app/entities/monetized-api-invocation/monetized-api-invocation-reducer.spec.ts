...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './monetized-api-invocation.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_MONETIZEDAPIINVOCATION_LIST actions', async () => {
    ...
    it('dispatches FETCH_MONETIZEDAPIINVOCATION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_MONETIZEDAPIINVOCATION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_MONETIZEDAPIINVOCATION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_MONETIZEDAPIINVOCATION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_MONETIZEDAPIINVOCATION actions', async () => {
      const expectedActions = [
        {
